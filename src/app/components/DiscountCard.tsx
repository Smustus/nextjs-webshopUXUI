...
const DiscountCard = () => {
  return (
    ...
    >
      ...
      <Button
        href="/products"
        className="bg-white text-gray-800/90 font-bold px-3 py-3 rounded-lg mt-6 hover:bg-gray-300 hover:text-gray-800 hover:scale-105 hover:shadow-lg transition-all duration-200 active:scale-100"
      >
        View Deals
      </Button>
    </article>
