...
const DetailedProductCard = (product: Product) => {
  ...
  return (
    <>
      <aside className="text-black/60 font-semibold pb-4">
        {
          <>
            <Link
              href={"/"}
      ...
      <section className="relative flex flex-col lg:flex-row gap-6">
        <DiscountMark
          discountPercent={discountPercent}
          position="top-3 left-4 scale-110"
        />
        <ImageDisplay
          product={product}
        ...
        <div className="w-full lg:w-2/3 flex flex-col">
          ...
          <div className="flex flex-wrap items-center my-4 gap-2">
            ...
            {product.discountPercentage > 0 && (
              <span
                className="text-base xl:text-lg text-gray-800 line-through"
                aria-live="polite"
              >
          ...
          <div
            aria-live="polite"
            className="text-red-900 font-bold text-base my-3"
            role="alert"
          >
            {message}
          </div>
      ...
      <section className="mt-10 text-gray-700">
        <div className="flex w-fit">
          ...
          <span className="flex items-center justify-center ml-auto pr-2.5 py-0 sm:py-1 text-base rounded-full font-semibold drop-shadow-md h-fit">
